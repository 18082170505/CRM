...
<%
	//获取服务器缓存中保存的pMap(属性文件Stage2Possibility.properties中的键值对)
...
<script type="text/javascript" src="../../jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	<script type="text/javascript">
		...
		/*
		 1.数据量不是很大
		 2.是一种键值对的对应关系
		 对于以上类型数据想到使用properties属性文件来保存
		 Stage2Possibility.properties
		 01资质审查=10
		 02需求分析=20
		 注意：属性配置文件不支持中文，需要将中文转码（使用jdk中bin目录下的native2ascii.exe）
		 */
		...
		$(function () {
			...
			//为阶段的下拉框绑定选中下拉框的事件，根据选中的阶段填写可能性
			$("#create-transactionStage").change(function () {
				//取得选中的阶段
				var stage = $("#create-transactionStage").val()
				//需要将服务器缓存中保存的java键值对（pMap）转换为json数据才能访问
				//注意此时不能通过json.stage的形式取值，因为stage是变量，必须以json[stage]的形式取值
...
<body>
	...
	<form class="form-horizontal" action="save.do" id="TransForm" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="华为宣传会">
				<input type="hidden" name="activityId" value="00e2464e68ec4482a76fb0d73522d048">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="7cb1a58c8b4646b7912afb883a0f242f">
			</div>
		</div>
